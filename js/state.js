...
let selectableEventTables = []; // ausschließlich aus Supabase; keine Fallback-/OSM-Platten im Erstellen-Flow
...
let _createEventReturnToChoice = false;
let _mitspielerReturnToChoice  = false;
